...
<html>
  ...
  <body class="body" leftmargin="0" rightmargin="0">
     <table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#F7F3F7">
          <tr height="26">
              <td class="blackTitle" align="center">航班编号</td>
              <td class="blackTitle" align="center">航班线路</td>
              <td class="blackTitle" align="center">机票类型</td>
		  ...
		  <tr class="text" align="center" bgcolor="#FFFFFF">
			  <td>${orderitem.hangban.bianhao}</td>
			  <td>${orderitem.hangban.shifadi}-${orderitem.hangban.daodadi}</td>
